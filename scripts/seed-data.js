...
const services = [
  {
    ...
    description_en:
      'Professional contract drafting and review services to protect your interests',
    description_ms:
      'Perkhidmatan penggubalan dan semakan kontrak profesional untuk melindungi kepentingan anda',
  ...
  },
  {
    ...
    description_en:
      'Handle employment contracts, termination, wage disputes and other labor law issues',
    description_ms:
      'Mengendalikan kontrak pekerjaan, penamatan, pertikaian gaji dan isu undang-undang buruh lain',
  ...
  },
  {
    ...
    description_en:
      'Comprehensive legal services for property sales, leasing, and title transfers',
    description_ms:
      'Perkhidmatan undang-undang komprehensif untuk jualan hartanah, pajakan, dan pemindahan hak milik',
  ...
  },
  {
    ...
    description_en:
      'Professional handling of divorce, property division, child custody and other family law matters',
    description_ms:
      'Pengendalian profesional perceraian, pembahagian harta, hak penjagaan anak dan perkara undang-undang keluarga lain',
  ...
  },
  {
    ...
    description_en:
      'Professional legal defense services for criminal defendants',
    description_ms:
      'Perkhidmatan pembelaan undang-undang profesional untuk defendan jenayah',
...
const templates = [
  {
    ...
    description_en:
      'Standard tenancy agreement template with all necessary clauses',
    description_ms:
      'Templat perjanjian sewa standard dengan semua klausa yang diperlukan',
  ...
  },
  {
    ...
    description_en:
      'Standard employment contract template compliant with Malaysian labor laws',
    description_ms:
      'Templat kontrak pekerjaan standard yang mematuhi undang-undang buruh Malaysia',
  ...
  },
  {
    ...
    description_en:
      'General power of attorney template for various legal matters',
    description_ms:
      'Templat surat kuasa wakil am untuk pelbagai perkara undang-undang',
  ...
  },
  {
    ...
    description_ms:
      'Templat NDA perniagaan untuk melindungi rahsia perdagangan anda',
...
const articles = [
  {
    ...
    content_zh:
      '租赁合同是房东和租客之间的重要法律文件。本文将详细介绍如何起草一份完善的租赁合同，避免日后产生纠纷。\n\n首先，合同应明确规定租金金额、支付方式和时间。其次，要详细列明双方的权利和义务...',
    content_en:
      'A tenancy agreement is an important legal document between landlord and tenant. This article explains how to draft a comprehensive tenancy agreement to avoid future disputes...',
    content_ms:
      'Perjanjian sewa adalah dokumen undang-undang penting antara tuan tanah dan penyewa. Artikel ini menerangkan cara merangka perjanjian sewa yang komprehensif untuk mengelakkan pertikaian masa depan...',
    excerpt_zh: '了解如何起草完善的租赁合同，保护您的权益',
    excerpt_en:
      'Learn how to draft a comprehensive tenancy agreement to protect your rights',
    excerpt_ms:
      'Ketahui cara merangka perjanjian sewa yang komprehensif untuk melindungi hak anda',
    author: '陈建国律师',
    read_time: 8,
    views: 1245,
    image_url:
  ...
  },
  {
    ...
    title_ms:
      'Apa Yang Perlu Dilakukan Jika Anda Diberhentikan Secara Tidak Adil?',
    content_zh:
      '在马来西亚，员工如果被无故解雇，可以向劳工法庭提出申诉。本文将介绍相关的法律程序和维权途径。\n\n根据1955年劳工法令，雇主必须有正当理由才能解雇员工...',
    content_en:
      'In Malaysia, employees who are unfairly dismissed can file a complaint with the Industrial Court. This article explains the legal procedures and remedies available...',
    content_ms:
      'Di Malaysia, pekerja yang diberhentikan secara tidak adil boleh memfailkan aduan ke Mahkamah Perusahaan. Artikel ini menerangkan prosedur undang-undang dan remedi yang tersedia...',
    excerpt_zh: '了解您在被无故解雇时的法律权利和救济途径',
    excerpt_en:
      'Understand your legal rights and remedies when unfairly dismissed',
    excerpt_ms:
      'Fahami hak undang-undang dan remedi anda apabila diberhentikan secara tidak adil',
    author: '李美玲律师',
    read_time: 10,
    views: 987,
    image_url:
  ...
  },
  {
    ...
    title_ms:
      'Isu Undang-undang Yang Perlu Dipertimbangkan Semasa Membeli Hartanah Jualan Semula',
    content_zh:
      '购买二手房涉及多个法律环节，买家需要特别注意产权调查、贷款审批、买卖合约等事项。\n\n首先，务必进行彻底的产权调查，确保卖家拥有合法的产权...',
    content_en:
      'Buying resale property involves multiple legal steps. Buyers need to pay attention to title searches, loan approvals, and sale agreements...',
    content_ms:
      'Membeli hartanah jualan semula melibatkan beberapa langkah undang-undang. Pembeli perlu memberi perhatian kepada carian hak milik, kelulusan pinjaman, dan perjanjian jualan...',
    excerpt_zh: '购买二手房前必须了解的重要法律事项',
    excerpt_en:
      'Important legal matters to understand before buying resale property',
    excerpt_ms:
      'Perkara undang-undang penting yang perlu difahami sebelum membeli hartanah jualan semula',
    author: '王志强律师',
    read_time: 12,
    views: 1567,
    image_url:
  ...
  },
  {
    ...
    content_zh:
      '在离婚案件中，子女抚养权的判定是最重要也最敏感的问题之一。法院在判定抚养权时，会以子女的最佳利益为首要考虑。\n\n法院会考虑多个因素，包括父母的经济能力、居住环境、子女的意愿等...',
    content_en:
      'In divorce cases, child custody determination is one of the most important and sensitive issues. Courts prioritize the best interests of the child...',
    content_ms:
      'Dalam kes perceraian, penentuan hak penjagaan anak adalah salah satu isu yang paling penting dan sensitif. Mahkamah mengutamakan kepentingan terbaik kanak-kanak...',
    excerpt_zh: '了解法院如何判定离婚后的子女抚养权',
    excerpt_en: 'Understand how courts determine child custody after divorce',
    excerpt_ms:
      'Fahami bagaimana mahkamah menentukan hak penjagaan anak selepas perceraian',
    author: 'Sarah Tan',
    read_time: 15,
    views: 2134,
    image_url:
    ...
    if (lawyersData && lawyersData.length > 0) {
      const consultations = [
        ...
        },
        {
          ...
          case_description:
            '公司突然通知我被解雇，但没有给出任何理由，我该怎么办？',
          status: 'confirmed',
        },
      ]

      const { data: consultationsData, error: consultationsError } =
        await supabase.from('consultations').insert(consultations).select()
