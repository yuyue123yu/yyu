...
async function executeMigration() {
  ...
  const migrationPath = path.resolve(
    process.cwd(),
    'supabase/001_create_tenants_table.sql',
  )
  const sql = fs.readFileSync(migrationPath, 'utf8')

  console.log('📄 Migration file loaded\n')
  console.log(
    '⚠️  Note: Due to Supabase client limitations, complex SQL migrations',
  )
  console.log(
    '   should be executed through the Supabase Dashboard SQL Editor.\n',
  )
  console.log('📋 Please follow these steps:\n')
  console.log(
    '1. Go to: https://supabase.com/dashboard/project/ovtrvzbftinsfwytzgwy/sql/new',
  )
  ...
  if (error) {
    if (error.message.includes('relation "public.tenants" does not exist')) {
      ...
      console.log(
        '📝 Please execute the migration SQL manually as described above\n',
      )
      ...
      console.log(
        '   You can copy this file content to the Supabase SQL Editor\n',
      )
    } else {
