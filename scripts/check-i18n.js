...
function main() {
  ...
  console.log(
    `Chinese coverage: ${existingKeys.zh.size}/${foundKeys.size} (${Math.round((existingKeys.zh.size / foundKeys.size) * 100)}%)`,
  )
  console.log(
    `English coverage: ${existingKeys.en.size}/${foundKeys.size} (${Math.round((existingKeys.en.size / foundKeys.size) * 100)}%)`,
  )
  console.log(
    `Malay coverage: ${existingKeys.ms.size}/${foundKeys.size} (${Math.round((existingKeys.ms.size / foundKeys.size) * 100)}%)`,
  )
  console.log('')
}
