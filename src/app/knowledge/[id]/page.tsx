                    ...
                    <div className="prose prose-lg max-w-none">
                      ...
                      {article.category === 'employment' && (
                        <>
                          ...
                          <p className="text-neutral-700 leading-relaxed mb-6">
                            马来西亚的《1955年雇佣法》（Employment Act
                            1955）是规范雇主与雇员关系的主要法律。该法律适用于月薪不超过RM
                            2,000的员工，以及从事体力劳动的员工（无论薪资多少）。
                          </p>
                      ...
                      {article.category === 'property' && (
                        <>
                          ...
                          <p className="text-neutral-700 leading-relaxed mb-6">
                            外国人可以在马来西亚购买房产，但有最低价格限制（通常为RM
                            1,000,000）。不同州属的规定可能有所不同。
                          </p>
                        </>
                      )}
                      ...
                      {article.category === 'business' && (
                        <>
                          ...
                          <p className="text-neutral-700 leading-relaxed mb-6">
                            马来西亚主要的公司类型包括：私人有限公司（Sdn
                            Bhd）、有限责任合伙（LLP）、独资企业和合伙企业。最常见的是Sdn
                            Bhd。
                          </p>
                      ...
                      {![
                        ...
                        <>
                          ...
                          <p className="text-neutral-700 leading-relaxed mb-6">
                            本文详细介绍了{article.titleCn || article.title}
                            的相关法律知识，帮助您更好地了解马来西亚的法律规定。
                          </p>
                          <p className="text-neutral-700 leading-relaxed mb-6">
