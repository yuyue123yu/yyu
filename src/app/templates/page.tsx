...
export default function TemplatesPage() {
  ...
  const handleDownload = async (id: string, title: string) => {
    ...
    try {
      ...
      // 动态导入PDF生成库（减少初始加载）
      const { generateTemplatePDF, downloadPDF } =
                ...
                <span>
                  ...
                  {language === 'zh'
                    ...
                    : language === 'en'
                      ...
                      : 'Templat Undang-undang Profesional'}
                </span>
              </div>
                        ...
                        <div>
                          {template.price === 0 ? (
                            <div className="flex items-center gap-2">
                              ...
                              <span className="px-2.5 py-1 bg-gradient-to-r from-green-100 to-green-200 text-green-700 text-xs font-bold rounded-full border border-green-300">
                                FREE
                              </span>
                            </div>
                          ) : (
          ...
          <div className="container mx-auto px-6">
            <div className="text-center mb-10">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-neutral-900 mb-3">
                {t('pages.popularCategories')}
              </h2>
              <p className="text-neutral-600 text-lg">
                {language === 'zh'
                  ? '浏览最受欢迎的法律文书分类'
                  : language === 'en'
                    ? 'Browse the most popular legal document categories'
                    : 'Layari kategori dokumen undang-undang yang paling popular'}
              </p>
            </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-blue-50 rounded-xl p-6 border border-blue-200">
                    <h3 className="font-bold text-neutral-900 mb-3 text-lg">
                      {t('pages.detailedDescription')}
                    </h3>
                    <p className="text-neutral-700 leading-relaxed">
                      {language === 'zh' &&
                        `这是一份专业的${selectedTemplate.title}，符合马来西亚法律要求。该模板由专业律师审核，包含所有必要的法律条款和条件。您可以根据自己的需求进行修改和定制。`}
                      {language === 'en' &&
                        `This is a professional ${selectedTemplate.title} that complies with Malaysian legal requirements. The template has been reviewed by professional lawyers and includes all necessary legal terms and conditions. You can modify and customize it according to your needs.`}
                      {language === 'ms' &&
                        `Ini adalah ${selectedTemplate.title} profesional yang mematuhi keperluan undang-undang Malaysia. Templat ini telah disemak oleh peguam profesional dan mengandungi semua terma dan syarat undang-undang yang diperlukan. Anda boleh mengubah suai dan menyesuaikannya mengikut keperluan anda.`}
                    </p>
                  </div>
