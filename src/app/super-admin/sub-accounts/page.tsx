...
function SubAccountsPage() {
  ...
  useEffect(() => {
    fetchUsers();
  }, [currentPage, search, roleFilter, statusFilter, tenantFilter]);
      ...
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600 mt-2">管理所有租户的子账号</p>
          </div>
          <button
...
export default withSuperAdminAuth(SubAccountsPage);
