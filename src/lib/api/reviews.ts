...
const mockReviews: UserReview[] = [
  {
    ...
    content:
      'The lawyer was very professional and helped me resolve my property dispute quickly. Highly recommended!',
    rating: 5,
    comment:
      'Excellent service! The lawyer was very professional and helped me resolve my property dispute quickly.',
    date: '2024-01-20',
  ...
  },
  {
    ...
    content:
      'Very satisfied with the legal consultation. Clear explanations and reasonable pricing. Would definitely recommend.',
    rating: 5,
    comment:
      'Very satisfied with the legal consultation. Clear explanations and reasonable pricing.',
    date: '2024-01-18',
    location: 'Penang',
  ...
  },
  {
    ...
    content:
      'Good experience overall. The lawyer was knowledgeable and responsive to all my business law queries.',
    rating: 4,
    comment:
      'Good experience overall. The lawyer was knowledgeable and responsive.',
    date: '2024-01-15',
    location: 'Johor',
  ...
  },
  {
    ...
    content:
      'Highly recommend! Professional service and great results. Helped me with my employment dispute efficiently.',
    rating: 5,
  ...
  },
  {
    ...
    content:
      'Outstanding legal advice. Very helpful and patient in explaining complex legal matters. Excellent service!',
    rating: 5,
    comment:
      'Outstanding legal advice. Very helpful and patient in explaining complex legal matters.',
    date: '2024-01-10',
    location: 'Kuala Lumpur',
  ...
  },
  {
    ...
    content:
      'Good service and fair pricing. Would use again for future property matters. Very satisfied with the outcome.',
    rating: 4,
...
export async function fetchTopReviews(
  ...
  return mockReviews.sort((a, b) => b.rating - a.rating).slice(0, limit)
}
