  ...
  const employmentTemplates = [
    {
      ...
      desc: 'Standard employment contract compliant with Malaysian Employment Act 1955',
    },
    {
      title: 'Part-Time Employment Agreement',
      desc: 'Part-time work agreement with flexible hours',
    },
    {
      title: 'Fixed-Term Contract',
      desc: 'Fixed-term employment contract template',
    },
  ]
  ...
  const propertyTemplates = [
    {
      ...
      desc: 'Property sale agreement for residential and commercial properties',
    },
    {
      title: 'Property Transfer Agreement',
      desc: 'Property ownership transfer document',
    },
  ...
  const tenancyTemplates = [
    {
      ...
      desc: 'Residential tenancy contract',
    },
...
export const templateCategories: TemplateCategory[] = [
  ...
  },
  {
    ...
    nameMs: 'Perjanjian Hartanah',
    nameCn: 'Property',
    count: mockTemplates.filter((t) => t.category === 'property').length,
    icon: '🏠',
  },
  {
    id: 'business',
    name: 'Business Contracts',
    nameMs: 'Kontrak Perniagaan',
    nameCn: 'Business',
  ...
  },
  {
    ...
    nameMs: 'Perjanjian Sewa',
    nameCn: 'Tenancy',
    count: mockTemplates.filter((t) => t.category === 'tenancy').length,
    icon: '🔑',
  },
]

// Fetch all templates
export async function fetchLegalTemplates(
  category?: string,
  language?: string,
