...
export const knowledgeCategories: KnowledgeCategory[] = [
  ...
  },
  {
    ...
    nameMs: 'Undang-undang Imigresen',
    nameCn: 'Immigration Law',
    articleCount: 54,
    icon: '✈️',
  },
  {
...
const mockArticles: LegalArticle[] = [
  {
    ...
    category: 'employment',
    summary:
      'A comprehensive guide to employee rights and employer obligations under Malaysian law',
    content:
      'The Employment Act 1955 is the main legislation governing employment in Malaysia...',
  ...
  },
  {
    ...
    category: 'property',
    summary:
      'Learn about property ownership, transfer procedures, and legal requirements',
    content:
      'Property ownership in Malaysia is governed by the National Land Code 1965...',
    author: 'Tan Mei Ling',
  ...
  },
  {
    ...
    category: 'family',
    summary:
      'Understanding divorce laws, procedures, and child custody arrangements',
    content:
      'Divorce in Malaysia is governed by different laws depending on religion...',
    author: 'Sarah Wong',
  ...
  },
  {
    ...
    category: 'business',
    summary:
      'Complete guide to business registration, licenses, and compliance',
    content:
      'Starting a business in Malaysia requires understanding various legal requirements...',
    author: 'Kumar Rajesh',
  ...
  },
  {
    ...
    content:
      'The Consumer Protection Act 1999 provides comprehensive protection...',
    author: 'Lee Ming',
  ...
  },
  {
    ...
    summary:
      'Guide for foreign workers and employers on work permits in Malaysia',
    content:
      'Foreign nationals working in Malaysia must obtain proper work authorization...',
    author: 'Raj Kumar',
...
// Fetch all articles
export async function fetchLegalArticles(
  category?: string,
  limit?: number,
...
export async function fetchPopularArticles(
  ...
  await new Promise((resolve) => setTimeout(resolve, 300))
  return [...mockArticles].sort((a, b) => b.views - a.views).slice(0, limit)
}
