...
const testimonials = [
  {
    ...
    company: '科技公司 CEO',
    content:
      '通过 LegalMY 找到了专业的商业律师，帮我们完成了公司重组。整个过程非常顺利，律师专业且响应迅速。强烈推荐！',
    rating: 5,
    avatar: '👨‍💼',
    case: 'business',
  },
  {
    ...
    company: '家庭主妇',
    content:
      '在离婚财产分配的问题上，律师给了我很大帮助。不仅专业，而且非常有耐心，让我在困难时期感到被支持。',
    rating: 5,
    avatar: '👩',
    case: 'family',
  },
  {
    ...
    company: '投资公司',
    content:
      '处理房产纠纷时，律师的专业知识和谈判技巧让我印象深刻。最终以最优方案解决了问题，节省了大量时间和金钱。',
    rating: 5,
    avatar: '👨‍💼',
    case: 'property',
  },
  {
    ...
    company: '电商平台',
    content:
      '从公司注册到合同审查，律师团队一直在帮助我们。价格透明，服务专业，是创业者的好帮手。',
    rating: 5,
    avatar: '👩‍💼',
    case: 'business',
  },
  {
    ...
    company: '制造业',
    content:
      '劳动纠纷处理得非常专业，律师不仅懂法律，还理解商业运作。给出的建议既合法又实用。',
    rating: 5,
    avatar: '👨',
    case: 'employment',
  },
  {
    ...
    company: '教师',
    content:
      '第一次使用在线法律咨询，没想到这么方便。律师很专业，解答了我所有的疑问，而且价格合理。',
    rating: 5,
    avatar: '👩‍🏫',
    case: 'criminal',
  },
        ...
        <div className="text-center mt-10">
          <div className="inline-flex items-center gap-2 bg-green-50 text-green-700 px-6 py-3 rounded-full">
            ...
            <span className="font-semibold">
              4.9/5 {t('home.averageRating')}
            </span>
            <span className="text-green-600">
              · {t('home.basedOnReviews')} 12,450+ {t('home.reviewsCount')}
            </span>
          </div>
        </div>
      </div>
