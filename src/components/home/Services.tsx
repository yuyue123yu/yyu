      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3">
          {services.map((service) => {
            ...
            const color =
              colorMap[service.category] || 'from-gray-400 to-gray-500'
            ...
            return (
              ...
              >
                ...
                {/* 彩色背景 */}
                <div
                  className={`bg-gradient-to-br ${color} w-10 h-10 rounded-lg flex items-center justify-center mb-3 group-hover:scale-110 transition-transform`}
                >
                ...
                <div className="flex flex-col gap-2 text-xs text-neutral-500 pt-3 border-t border-neutral-100">
                  <div className="flex items-center justify-between">
                    <span>
                      {service.case_count}+ {t('common.cases')}
                    </span>
