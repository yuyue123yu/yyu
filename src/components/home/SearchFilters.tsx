...
export default function SearchFilters() {
  ...
  const toggleFilter = (filterType: string, value: string) => {
    setSelectedFilters((prev) => ({
      ...prev,
      [filterType]:
        prev[filterType as keyof typeof prev] === value ? 'all' : value,
    }))
  }
      ...
      <div className="container mx-auto px-6 py-3">
        ...
        {showFilters && (
          <div className="mt-2 md:mt-4 pt-2 md:pt-4 border-t border-neutral-200 grid grid-cols-2 md:grid-cols-5 gap-3 md:gap-6">
            {/* 价格筛选 */}
            <div>
              <h4 className="font-semibold text-xs md:text-sm mb-2 md:mb-3 text-neutral-900">
                {t('home.priceRange')}
              </h4>
                ...
                {[
                  ...
                  >
                    <input
                      ...
                      onChange={() =>
                        toggleFilter('responseTime', option.value)
                      }
                      className="w-3 h-3 md:w-4 md:h-4 rounded border-neutral-300"
                    />
                    <span className="text-xs md:text-sm text-neutral-700">
            ...
            <div>
              ...
              <div className="space-y-1.5 md:space-y-2">
                {[
                  ...
                  {
                    label: '',
                    labelKey: 'services.property',
                    value: 'property',
                  },
                  {
                    label: '',
                    labelKey: 'services.criminal',
                    value: 'criminal',
                  },
                ].map((option) => (
                  <label
